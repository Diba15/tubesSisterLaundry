...
def get_processing_time(service_type):
    print(f"===========[Waktu Pengerjaan {service_type}]==========")
...
processing_time_choice = get_processing_time("cuci basah" if service_type == '1' else "cuci kering")
...
if processing_time_choice == '1':
    price_per_kg = 9000 if service_type == '1' else 8000
elif processing_time_choice == '2':
    price_per_kg = 8000 if service_type == '1' else 7000
elif processing_time_choice == '3':
    price_per_kg = 7000 if service_type == '1' else 6000
